  ...
  if (activeQuizToTake) {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-slate-900 flex flex-col text-white">
        ...
        <header className="bg-slate-900 border-b border-slate-800 px-4 py-3 flex items-center justify-between gap-3 shrink-0">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              className="p-2 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-300 text-xs font-bold transition-all flex items-center gap-1"
              title="Buka di Tab Baru / Layar Penuh"
            >
        ...
        {/* Embedded Quiz Frame / Direct Display */}
                  ...
                  {canAccess ? (
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="flex-1 min-h-[44px] flex items-center justify-center gap-2 px-5 py-2.5 rounded-2xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs sm:text-sm shadow-md shadow-teal-600/20 transition-all cursor-pointer"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="min-h-[44px] px-3.5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:text-teal-600 dark:hover:text-teal-400 flex items-center justify-center transition-colors"
