            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white font-heading tracking-tight">
                  Manajemen Kuis PJOK (Link & Kunci)
                </h1>
                <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
                  Guru cukup memasukkan link (Google Form, Quizizz, dll). Kunci & buka akses kuis kapan saja secara real-time agar murid menjawab sesuai waktu Anda.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-800">
              <div className="flex items-center gap-2.5">
                ...
                <h3 className="text-lg font-black text-slate-900 dark:text-white font-heading">
                  {editingQuiz ? 'Edit Link & Kunci Kuis' : 'Tambah Link Kuis Guru'}
                </h3>
              </div>
              <button
